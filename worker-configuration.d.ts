/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.ssr.jsonc` (hash: b2de0191af8e5b7bb9efdd28dbc148e1)
...
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./dist-ssr/server/entry");
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DEV_PUBLISH_TOKEN" | "DEV_PUBLISH_AUTHOR">> {}
}
