...
out.append('')
out.append('Son 20 yayın kategori sayımı:')
...
- site çizgisi global odaklı Türkçe yayındır; yerel Türkiye gündemini ayrı kategori, kota veya öncelik gibi ele alma
- Türkiye bağlantılı bir konu yalnız global bağlamı güçlüyse değerlendirilebilir; yerel parti/gündem akışını sırf Türkiye kaynaklı diye öne çıkarma
